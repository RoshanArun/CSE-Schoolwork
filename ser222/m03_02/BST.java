...
public interface BST<Key, Value> extends OrderedSymbolTable<Key, Value> {
    ...
    /**
     * Puts a key value pair into the tree. If key already exists, then only updates
     * value.
     * 
    ...
    /**
     * Returns the value paired with a key in the tree. Returns null if key does not
     * exist.
     * 
