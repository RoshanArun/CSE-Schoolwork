...
public class Main {
    ...
    public static void testIntegers(SymbolTable<Integer, Integer> st) {
        ...
        // note: the following code does not check if keys is maintained properly - it
        // should.
    ...
    public static void testStrings(SymbolTable<String, Integer> st) {
        ...
        Set<String> keys = new HashSet<>(
                Arrays.asList("DFKDJSFS", "DAFDW", "XZC", "adsfas", "a", "B", "112323", "<Object>", "AAAA", "A"));
        st.put("DFKDJSFS", 21);
        st.put("DAFDW", 52);
        st.put("XZC", 5);
        st.put("adsfas", 8);
        ...
        // note: the following code does not check if keys is maintained properl- it
        // should.
