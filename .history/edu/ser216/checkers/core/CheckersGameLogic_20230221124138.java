...
public class CheckersGameLogic implements CheckersGame {
    ...
    public void doTurn() {
        ...
        int startRow = Character.getNumericValue(move.charAt(0));
        int startCol = charToInt(move.charAt(1));
        int endRow = Character.getNumericValue(move.charAt(3));
        int endCol = charToInt(move.charAt(4));
