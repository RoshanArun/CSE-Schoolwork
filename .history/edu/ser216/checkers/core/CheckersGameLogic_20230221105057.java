...
public class CheckersGameLogic implements CheckersGame {
    ...
    public void doTurn() {
        ...
        char letter2 = input.charAt(3);
        char number2 = input.charAt(4);

        int startRow = charToInt(number);

        int startCol = charToInt2(letter);
        int endRow = charToInt(number2);
        int endCol = charToInt2(letter2);
