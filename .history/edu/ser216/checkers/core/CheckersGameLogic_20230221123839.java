...
public class CheckersGameLogic implements CheckersGame {
    ...
    private boolean isValidMove(int startRow, int startCol, int endRow, int endCol) {
        ...
        // checks if there is a friendly piece in the middle if the movement is further
        // than one
        if (Math.abs(endRow - startRow) == 2) {
            if (board[(endRow + startRow) / 2][(endCol + startCol) / 2] != 'o' && board[startRow][startCol] == 'x') {
                return false;
            }
            if (board[(endRow + startRow) / 2][(endCol + startCol) / 2] != 'x' && board[startRow][startCol] == 'o') {
                return false;
            }
        }
