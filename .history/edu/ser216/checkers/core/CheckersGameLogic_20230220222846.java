    ...
    private boolean isValidMove(int startRow, int startCol, int endRow, int endCol) {
        ...
        if (turn % 2 == 0 && getSquare(startRow, startCol) == 'x') {
            if (Math.abs(startRow - endRow) == 2 && Math.abs(startCol - endCol) == 2) {
                if (getSquare(startRow + 1, startCol + 1) == 'o' || getSquare(startRow - 1, startCol - 1) == 'o'
                        || getSquare(startRow + 1, startCol - 1) == 'o'
                        || getSquare(startRow - 1, startCol + 1) == 'o') {
                    setSquare(startRow + 1, startCol + 1, '_');
                    setSquare(startRow - 1, startCol - 1, '_');
                    setSquare(startRow + 1, startCol - 1, '_');
                    setSquare(startRow - 1, startCol + 1, '_');
                }
            }
        } else if (turn % 2 == 1 && getSquare(startRow, startCol) == 'o') {
            if (Math.abs(startRow - endRow) == 2 && Math.abs(startCol - endCol) == 2) {
                if (getSquare(startRow + 1, startCol + 1) == 'x' || getSquare(startRow - 1, startCol - 1) == 'x'
                        || getSquare(startRow + 1, startCol - 1) == 'x'
                        || getSquare(startRow - 1, startCol + 1) == 'x') {
                    setSquare(startRow + 1, startCol + 1, '_');
                    setSquare(startRow - 1, startCol - 1, '_');
                    setSquare(startRow + 1, startCol - 1, '_');
