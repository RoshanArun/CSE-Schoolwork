...
public class CheckersGameLogic implements CheckersGame {
    ...
    public void nextTurn() {
        if (turn % 2 == 0 && turn != 0) {
            System.out.println(
                    "\nPlayer X - your turn. \nChoose a cell position of piece to be moved andthe new position. e.g., 3a-4b 3g-4h");
        } else {
            System.out.println(
                    "\nPlayer O - your turn. \nChoose a cell position of piece to be moved andthe new position. e.g., 3a-4b 3g-4h");
        }
    ...
    public void doTurn() {
        if (turn == 0) {
            System.out.println(
                    "\nBegin Game. Player X - your turn. \nChoose a cell position of piece to bemoved and the new position. e.g., 3a-4b 3g-4h ");
        }
