...
public interface CheckersGame {
    ...
    /**
     * Returns 'x' if player X has won, 'o' if player O has won, and '_' otherwise.
     * May be called
     * at any time.
     *
    ...
    /**
     * Indicates to the game that a players turn should occur (i.e., read a move and
     * act upon it).
     * To read input from the keyboard, this method must make use of the Scanner
     * object passed
     * into the constructor of this CheckersGame. Valid inputs must look like
     * "3a-4b".
     */
    public void doTurn();

    /**
     * Indicates to the game that it is over. Used to do things like display the
     * winner.
     */
    public void onEnd();
